...
class DeduplicationManager {
     ...
     */
    isActionProcessed(roomId, actionId) {
     ...
     */
    recordProcessedAction(roomId, actionId) {
 ...
 */
export function checkAndRecordAction(roomId, actionId) {
